  ...
  return (
    <section className="bg-gray-100 py-12">
      <div className="max-w-6xl mx-auto px-4">
        <h2 className="text-3xl text-black font-bold text-center mb-10">🌟 Why Choose Us?</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
          <div className="bg-white p-6 rounded-xl shadow">
            <FaStar className="text-4xl mx-auto text-yellow-500 mb-4" />
            <h3 className="text-xl text-black font-semibold mb-2">Top Rated Guides</h3>
          ...
          <div className="bg-white p-6 rounded-xl shadow">
            ...
            <h3 className="text-xl text-black font-semibold mb-2">Best Price Guarantee</h3>
          ...
          <div className="bg-white p-6 rounded-xl shadow">
            ...
            <h3 className="text-xl text-black font-semibold mb-2">24/7 Support</h3>
